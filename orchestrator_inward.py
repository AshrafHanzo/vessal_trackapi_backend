...
def run():
    print("=" * 60)
    print("ORCHESTRATOR: INWARD (ICEGATE)")
    ...
    for container in containers:
        try:
            ...
            # RULE: Eligibility check for status 'IGM' or any later status missing 'Inward'
            # (Based on USER requirement: Always find Inward even for late jobs)
            eligible_statuses = ["IGM", "Inward", "Port In", "Port Out", "Customs"]
            ...
            job_payload = {
                ...
                "igm_no": container.get("igm_no") or extra_info.get("igm_no"),
                "igm_date": container.get("igm_date") or extra_info.get("igm_date"),
    ...
    print("ORCHESTRATOR: INWARD FINISHED")
    print("=" * 60)
