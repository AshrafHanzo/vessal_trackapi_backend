                    ...
                    try:
                        ...
                        if correct_table:
                            ...
                            if rows:
                                ...
                                result["igm_no"]   = cell_texts[col_indices['igm_no']] if col_indices.get('igm_no') is not None and col_indices['igm_no'] < len(cell_texts) else ""
                                result["igm_date"] = cell_texts[col_indices['igm_date']] if col_indices.get('igm_date') is not None and col_indices['igm_date'] < len(cell_texts) else ""
                                result["inw_date"] = cell_texts[col_indices['inw_date']] if col_indices.get('inw_date') is not None and col_indices['inw_date'] < len(cell_texts) else ""
