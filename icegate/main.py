...
async def track_document(
    ...
    bl_no: str = Query(None, description="Bill of Lading number (defaults to MBL if not provided)"),
    ...
    - **bl_no**: Bill of Lading number (optional — uses MBL if not provided)
    """
    # FALLBACK: If HBL is not provided, use MBL as HBL
    if not bl_no:
        bl_no = mbl_no
