...
def run():
    print("=" * 60)
    print("ORCHESTRATOR: CUSTOMS (CFS ARRIVAL)")
    ...
    for container in containers:
        try:
            ...
            # RULE: Eligibility check for 'Port Out' status
            # As per document, Customs (CFS Arrival) starts pushing after 'Port Out'
            if status != "Port Out":
    ...
    print("ORCHESTRATOR: CUSTOMS FINISHED")
    print("=" * 60)
